...
@section('content')
    <div class="p-6 sm:p-16">
        ...
        <div class="mb-4">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center sm:justify-center" id="myTab"
        ...
        <div id="myTabContent">
            <div class="hidden p-2 sm:grid grid-cols-1 sm:grid-cols-4 rounded-lg gap-4 bg-gray-50" id="profile"
            ...
            <div class="hidden p-2 sm:grid grid-cols-1 sm:grid-cols-4 rounded-lg gap-4 bg-gray-50" id="dashboard"
            ...
            <div class="hidden p-2 sm:grid grid-cols-1 sm:grid-cols-4 rounded-lg gap-4 bg-gray-50" id="settings"
            ...
            <div class="hidden p-2 sm:grid grid-cols-1 sm:grid-cols-4 rounded-lg gap-4 bg-gray-50" id="contacts"
            ...
            <div class="hidden p-2 sm:grid grid-cols-1 sm:grid-cols-4 rounded-lg gap-4 bg-gray-50" id="fani-zote"
                role="tabpanel" aria-labelledby="zote-tab">
                @for ($i = 0; $i <= 2; $i++)
                    <div class="bg-gray-200 rounded-xl mb-2">
                        <img src="images/caro-2.jpg" alt="Image" class="w-fit mb-2 sm:max-w-full h-48 rounded-t-xl">
                        <div class="p-4">
            ...
            <div class="hidden p-2 sm:grid grid-cols-1 sm:grid-cols-4 rounded-lg gap-4 bg-gray-50" id="comp"
                role="tabpanel" aria-labelledby="comp-tab">
                @for ($i = 0; $i <= 4; $i++)
                    <div class="bg-gray-200 rounded-xl mb-2">
                        <img src="images/caro-2.jpg" alt="Image" class="w-fit mb-2 sm:max-w-full h-48 rounded-t-xl">
                        <div class="p-4">
